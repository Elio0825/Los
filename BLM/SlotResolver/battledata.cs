...
public class BattleData
{
    ...
    public BlmLoopPhase LoopPhase { get; set; } = BlmLoopPhase.None;
    public int F4CountThisAF { get; set; } = 0;
    public bool UsedUiParadoxThisCycle { get; set; } = false;
    ...
    {
        LoopPhase = BlmLoopPhase.None;
        F4CountThisAF = 0;
        UsedUiParadoxThisCycle = false;
